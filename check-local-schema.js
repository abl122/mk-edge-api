...
async function main() {
  ...
  try {
    console.log('🔍 Verificando schema da collection "users" no MongoDB LOCAL...\n');
    
    console.log('📡 Conectando ao MongoDB local...');
    conn = await mongoose.createConnection(LOCAL_MONGODB_URL).asPromise();
    ...
    console.log('\n========================================');
    console.log('📋 INFORMAÇÕES GERAIS - LOCAL');
    console.log('========================================\n');
    ...
    console.log('\n========================================');
    console.log('📝 TODOS OS CAMPOS (LOCAL)');
    console.log('========================================\n');
